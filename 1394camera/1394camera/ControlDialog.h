...
/**\brief Encapsulate everything a control pane needs to survive, stored in GWL_USERDATA */
...
/**\brief Encapsulate everything the control dialog needs to survive, stored in GWL_USERDATA */
